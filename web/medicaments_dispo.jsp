            ...
            <tbody>
                <% for (Medicament m : medicamentsDisponibles) { %>
                    <tr>
                        ...
                        <td><%= m.getQuantite() %></td>
                        <td>
                            <!-- Formulaire pour acheter un médicament -->
                            <form method="post" action="MedicamentAchatController">
                                <input type="hidden" name="medicamentId" value="<%= m.getId() %>" />
                                <input type="number" name="quantite" min="1" max="<%= m.getQuantite() %>" required />
